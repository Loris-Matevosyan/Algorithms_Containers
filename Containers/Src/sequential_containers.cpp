...
{
    std::cout << "\n\n=============STRING=============\n" << std::endl;
    std::cout << "\n-----String Default constructor and overloaded constructor-----\n" << std::endl;
...
{
    std::cout << "\n-----String Copy constructor and copy assignment operator-----\n" << std::endl;
...
{
    std::cout << "\n-----String Move constructor and move assignment operator-----\n" << std::endl;
...
{
    std::cout << "\n-----String [] operator and at() function-----\n" << std::endl;
...
{
    std::cout << "\n-----String size(), capacity() and clear() functions-----\n" << std::endl;
...
{
    std::cout << "\n\n=============VECTOR=============\n" << std::endl;
    std::cout << "\n-----Vector Default constructor and overloaded constructor-----\n" << std::endl;
...
{
    std::cout << "\n-----Vector Copy constructor and copy assignment operator-----\n" << std::endl;
...
{
    std::cout << "\n-----Vector Move constructor and move assignment operator-----\n" << std::endl;
...
{
    std::cout << "\n-----Vector [] operator and at() function-----\n" << std::endl;
...
{
    std::cout << "\n-----Vector size(), capacity() and clear() functions-----\n" << std::endl;
...
{
    std::cout << "\n\n=============LIST=============\n" << std::endl;
    std::cout << "\n-----Lists Constructors and Operators-----\n" << std::endl;
